...
final class Version20211022124329 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO user (id, username, roles, password, full_name, is_verified, is_blocked, email, photo, date_of_birth, phone, sex_id) VALUES (nextval('admin_id_seq'), 'admin', '[\"ROLE_ADMIN\"]', '\$argon2id\$v=19\$m=65536,t=4,p=1\$34ha22VC+QgnSDEfsz7Mtw\$6pKGqzTx1EU218iv8xJNTup93uGE7VaeNDRb1Tt+Mik', admin, true, false, 'admin@mail.ru', '', '1990-01-01 00:00:00', '+79999999999', 1)");
    }
